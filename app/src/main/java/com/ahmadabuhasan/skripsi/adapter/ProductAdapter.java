...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public ProductAdapter(Context context2, List<HashMap<String, String>> productData2) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.textViewProductName.setText(this.productData.get(position).get(DatabaseOpenHelper.PRODUCT_ID));
        ...
        holder.imageViewDelete.setOnClickListener(v -> new AlertDialog.Builder(ProductAdapter.this.context).setMessage(R.string.want_to_delete_product)
                .setCancelable(false)
